...
// Définition des sections de la présentation avec des icônes
const sections = [
  { id: 1, title: '1.Introduction', slide: 3, icon: 'carbon:information' },
  { id: 2, title: '2.Évolution historique', slide: 7, icon: 'carbon:time' },
  { id: 3, title: '3.Principes fondamentaux', slide: 11, icon: 'carbon:touch-1' },
  { id: 4, title: '4.Spécificités mobiles', slide: 14, icon: 'carbon:mobile' },
  { id: 5, title: '5.Design et ergonomie', slide: 19, icon: 'carbon:design' },
  { id: 6, title: '6.Tendances et innovations', slide: 23, icon: 'carbon:idea' }
]
      ...
      <div class="nav-content bg-gradient-to-r from-gray-900 to-gray-800 shadow-lg py-1 px-4 flex items-center justify-between mx-4 mt-2 rounded-xl">
        ...
        <div class="flex items-center space-x-2">
          <div class="logo bg-orange-500 text-white p-1 rounded-md">
            <carbon:touch-1 class="text-lg" />
          </div>
          <div class="hidden sm:block text-white font-bold text-sm">Interfaces Tactiles</div>
        </div>
        ...
        <!-- Indicateur de slide plus discret -->
